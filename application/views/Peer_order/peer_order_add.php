...
<div class="wrapper">
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content">
      <div class="row">
	  <form action="<?=base_url();?>peer_order/save" method="post" role="form" enctype="multipart/form-data">
        <div class="col-md-6">
			...
			<div class="box box-success">
				...
				<div class="box-body">
					<div class="input-group date">
						...
						<input type="text" name="name" class="form-control" placeholder="訂單名稱" required>
					</div>
				</div>
				<div class="box-body">
					<label>代訂內容</label>
				...
				<div class="box-body">
					...
					<div class="input-group date">
						...
						<input type="text" name="adate" id="adate" class="datepicker" required>
				...
				<div class="box-body">
					...
					<div class="input-group date">
						...
						<input type="text" name="bdate" id="bdate" class="datepicker" onchange="get_price()" required>
				...
				<div class="box-body">
					...
					<div class="form-group">
						<div class="input-group">
							...
							<input type="text" name="cost" id="cost" class="form-control" onkeyup="get_profit()" placeholder="" required>
						</div>
					</div>
					<label>報價價格</label>
					<div class="form-group">
						<div class="input-group">
							<span class="input-group-addon">$</span>
							<input type="text" name="price" id="price" class="form-control" onkeyup="get_profit()"  placeholder="" required>
						</div>
					</div>
					<label>利潤 </label><h3 id="profit"></h3>
				</div>
				<div class="box-body">
					<label>發票需求</label>
					<div class="form-group">
