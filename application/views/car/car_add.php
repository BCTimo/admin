      ...
      <div class="row">
        <div class="col-xs-12">
			<div class="box box-primary">
				...
				<!-- /.box-header -->
				<!-- form start -->
				<form action="<?=base_url();?>car/save" method="post" role="form" enctype="multipart/form-data">
					<div class="box-body">
						<label>車種</label>
						<select name="type" class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true">
							<option value="1">遊覽車</option>
							<option value="2">大巴</option>
							<option value="3">9人座</option>
							<option value="4">小客車</option>
						</select>
					</div>
					<div class="box-body">
						<label>名稱</label>
						<div class="form-group">
							<input type="text" name="name" class="form-control" placeholder="Toyota Altis" required>
						</div>
					</div>
					<div class="box-body">
						<label>車牌</label>
						<div class="form-group">
							<input type="text" name="code" class="form-control" placeholder="ABC-123" required>
						</div>
					</div>
					...
					<div class="box-body">
						<label>驗車日</label>
						<div class="form-group">
							<input type="text" name="checkday" class="datepicker">
						</div>
					</div>
